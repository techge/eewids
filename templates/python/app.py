...
# Choose the captured frames you want to get for your detection app by uncommenting here
routing_key_table = [ 
    ## Management frames
    #"Association Request",
...
def detect_attack(data):
    ...
    print(" [x] Captured %s %r" % (data['subtype'][1], data['ESSID']))
